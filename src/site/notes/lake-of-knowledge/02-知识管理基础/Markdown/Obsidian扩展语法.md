---
{"uid":20230516140955,"title":"Obsidian 扩展语法","tags":["Markdown"],"description":"Obsidian 扩展语法，引用内容，内容引用，引用具体标题内容，自定义图片大小，callout语法速查","author":"OS","type":"basic","draft":false,"editable":false,"modified":20231025160203,"dg-publish":true,"permalink":"/lake-of-knowledge/02/markdown/obsidian/","dgPassFrontmatter":true}
---


# Obsidian 扩展语法

Obsidian 除了支持之前所说的 [[lake-of-knowledge/02-知识管理基础/Markdown/Markdown\|Markdown]] 基本语法，还有一些基于链接，和应用笔记，为了更方便产出而设置支持的扩展集。
...
具体可参考 [[lake-of-knowledge/10-Obsidian/Obsidian基本使用/标签的使用\|标签的使用]]
...
>[!Tip] 关联推荐
>- 如果你觉得 callout 可以服用到其他地方：[[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-list-callouts\|obsidian-list-callouts]]
>- 如果你希望优化样式：[[lake-of-knowledge/10-Obsidian/Obsidian外观/CSS 片段/Obsidian样式-Callout样式\|Obsidian样式-Callout样式]]
...
1. [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-emoji-toolbar\|obsidian-emoji-toolbar]]
2. [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/emoji-shortcodes\|emoji-shortcodes]]
3. [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-icon-shortcodes\|obsidian-icon-shortcodes]]
