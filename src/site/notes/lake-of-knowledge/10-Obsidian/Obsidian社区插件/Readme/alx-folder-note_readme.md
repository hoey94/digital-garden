---
{"uid":2023080322135658,"title":"Obsidian 插件：AidenLx's Folder Note","tags":["笔记文件处理","obsidian插件","readme"],"description":"使用文件夹笔记为文件夹添加描述、摘要和更多信息。","author":"AI","type":"readme","draft":false,"editable":false,"modified":20230101000000,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/readme/alx-folder-note-readme/","dgPassFrontmatter":true}
---
...
下面是 [[alx-folder-note\|alx-folder-note]] 插件的自述翻译
