---
{"uid":2023080322165083,"title":"Obsidian 插件：Custom Classes","tags":["obsidian插件","readme"],"description":"直接从您的笔记中为所选择的Markdown元素添加自己的HTML类。","author":"AI","type":"readme","draft":false,"editable":false,"modified":20230101000000,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/readme/custom-classes-readme/","dgPassFrontmatter":true}
---
...
下面是 [[custom-classes\|custom-classes]] 插件的自述翻译
...
````markdown
`class: my-dv-list`
- [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/Readme/custom-classes_readme.md|custom-classes_readme]]
