---
{"uid":20230709224524,"title":"Obsidian 插件：Homepage 打造属于自己的启动页","tags":["obsidian","插件","homepage","主页","启动页"],"description":"在启动 Obsidian 时，打开指定的笔记、图谱、白板文件或工作区布局","author":"cuman","type":"basic","draft":false,"editable":false,"modified":20230731105737,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/obsidian-homepage/","dgPassFrontmatter":true}
---
...
正常安装插件后，具体安装方法参考 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/Obsidian社区插件的安装\|Obsidian社区插件的安装]]，可以看到如下设置项。
...
很多设置都可以通过使用 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/quickadd\|quickadd]] 实现，但 homepage 把很多命令简化了。比如 [[lake-of-knowledge/01-社区资源合集/Blue Topaz 示例库/Blue Topaz 示例库简介\|Blue Topaz 示例库简介]] 里面使用的 homepage 插件 就是用了 `工作区` 这个选项，设置一个包含主页的工作区，保存后，就可以在启动 Ob 的时候直接加载工作区。
