---
{"uid":20230329145822,"title":"Obsidian 插件：Dynamic Background 为 Obsidian 添加动态背景","tags":["Obsidian","插件","动态背景","美化"],"description":"Obsidian 插件：Dynamic Background 为 Obsidian 添加动态背景","author":"OS","type":"other","draft":false,"editable":false,"modified":20230603022223,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/obsidian-dynamic-background/","dgPassFrontmatter":true}
---
...
如果您只想显示墙纸，而不想显示动态效果，关闭掉动态效果即可。具体操作参见 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-dynamic-background#启用或禁止动态效果\|#启用或禁止动态效果]]。
