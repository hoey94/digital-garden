---
{"uid":20230514144947,"title":"Obsidian 插件：Buttons 美化必备的按钮插件","tags":["Obsidian","插件","自动化","效率","按钮"],"description":"Obsidian 插件：Buttons 用快捷方式管理命令的最佳方式","author":"cuman","type":"basic","draft":false,"editable":false,"modified":20230911010407,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/buttons/","dgPassFrontmatter":true}
---
...
- 通过 buttons link 类型，配合 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-advanced-uri\|obsidian-advanced-uri]] 插件 调用 `Obsidian://` 开头的链接实现 ob 的功能。
- 通过 buttons link 类型，调用 `file:///` 比如 `file:///D:/Documents` 打开电脑中的文件
- 通过 buttons command 类型，调用插件创建的链接，比如 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/quickadd\|quickadd]] [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/templater/templater-obsidian\|templater-obsidian]] 都可以生成对应指令
- 通过 buttons template 类型 ,配合 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/templater/templater-obsidian\|templater-obsidian]]，直接调用模板。
- 通过 buttons 自定义 css，利用 [[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-admonition\|obsidian-admonition]] 插件生成一个容器，把按钮进去进行归类。 更多样式参考 [[lake-of-knowledge/01-社区资源合集/Blue Topaz 示例库/Blue Topaz 示例库简介\|Blue Topaz example]]
