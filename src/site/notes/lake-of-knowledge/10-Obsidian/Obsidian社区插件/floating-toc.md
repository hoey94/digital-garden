---
{"uid":20230329145817,"title":"Obsidian 插件：Floating TOC 为你添加悬浮的笔记目录","tags":["Obsidian","插件","目录","悬浮目录"],"description":"Obsidian 插件：Floating TOC 为你添加悬浮的笔记目录,自动同步高亮滚动位置, 折叠/展开目录","author":"OS","type":"other","draft":false,"editable":false,"modified":20231027235642,"dg-publish":true,"permalink":"/lake-of-knowledge/10-obsidian/obsidian/floating-toc/","dgPassFrontmatter":true}
---
...
Floating Toc 插件能实现悬浮目录。悬浮目录的效果近似你在其他网页文字处理协同上见到的效果，一般会悬浮在网页左侧，。简单来说就是在侧边存在能根据正文中标题文字自动生成的大纲。之前，我也介绍过另一款 TOC 插件：[[lake-of-knowledge/10-Obsidian/Obsidian社区插件/obsidian-dynamic-toc\|obsidian-dynamic-toc]]。
...
- 支持 [[lake-of-knowledge/10-Obsidian/Obsidian基本使用/窗口管理\|窗口管理]]
