---
{"dg-publish":true,"dlink":["[[线性代数]]"],"english":"determinant","japanese":"ぎょうれつしき","tags":null,"permalink":"/038-数字科学/math/线性代数/行列式/","dgPassFrontmatter":true}
---


# 同济版目录改
[[038-数字科学/math/线性代数/行列式定义\|行列式定义]]
[[038-数字科学/math/线性代数/全排列\|全排列]]
[[038-数字科学/math/线性代数/逆序数\|逆序数]]
[[对换\|对换]]
[[038-数字科学/math/线性代数/行列式性质\|行列式性质]]
[[038-数字科学/math/线性代数/行列式按行展开\|行列式按行展开]]
[[克拉默法则\|克拉默法则]]
...
- 提取公因数
- 高阶优先降阶
- 降阶善用[[038-数字科学/math/立方差公式\|立方差公式]]
